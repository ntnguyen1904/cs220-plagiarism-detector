...
//		IPlagiarismDetector detector = makeDetector(8);
//		IPlagiarismDetector detector = makeDetector(5);
		...
		// figure that out!
//		Collection<String> pairs1 = detector.getSuspiciousPairs(150);
		Collection<String> pairs1 = detector.getSuspiciousPairs(100);
